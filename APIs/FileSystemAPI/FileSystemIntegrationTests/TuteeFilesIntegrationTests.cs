...
//        var TuteeFiles = await response.Content.ReadFromJsonAsync<List<UserFiles>>();// ReadAsAsync<List<TuteeFile>>();
...
//    {
//        //Arrange
//        var testTuteeFile = new UserFiles()
//        {
//            Id = Guid.NewGuid(),
...
//        };
//        var testTuteeFile2 = new UserFiles()
//        {
...
//        };
//        var testTuteeFile3 = new UserFiles()
//        {
...
//        var TuteeFiles = await response.Content.ReadFromJsonAsync<List<UserFiles>>();
...
//        var TuteeFile = await response.Content.ReadFromJsonAsync<UserFiles>();
