...
//      List<UserFiles> _expectedTuteeFile = new List<UserFiles> { createTuteeFile(), createTuteeFile(), createTuteeFile(), createTuteeFile() };

//    //DTO
//    private static UserFiles createTuteeFile()
//    {
//        return new()
//        {
//            Id = Guid.NewGuid(),
...
//        repositoryStub.Setup(repo => repo.TuteeFiles.FindAsync(It.IsAny<Type>())).ReturnsAsync((UserFiles)null);
...
//        repositoryStub.Setup(repo => repo.TuteeFiles).Returns((DbSet<UserFiles>)null);
...
//        // Assert
//        Assert.IsType<ActionResult<FileSystem.Models.UserFiles>>(result);
...
//        var repositoryStub = new Mock<FilesContext>();
//        repositoryStub.Setup(repo => repo.TuteeFiles.FindAsync(It.IsAny<Guid>())).ReturnsAsync((UserFiles)null);
//        var controller = new TuteeFilesController(repositoryStub.Object);
...
//        var repositoryStub = new Mock<FilesContext>();
//        repositoryStub.Setup(repo => repo.TuteeFiles.Add(expectedTuteeFile)).Returns((Func<EntityEntry<UserFiles>>)null);
