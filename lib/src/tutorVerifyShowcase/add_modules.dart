...
// ignore: must_be_immutable
class ShowCaseAddModulesPage extends StatefulWidget {
  final Globals globals;
  List<Modules> currentModules;
  ShowCaseAddModulesPage(
      {Key? key, required this.globals, required this.currentModules})
      : super(key: key);

  @override
  _ShowCaseAddModulesPageState createState() => _ShowCaseAddModulesPageState();
}

class _ShowCaseAddModulesPageState extends State<ShowCaseAddModulesPage> {
