...
import 'settings_pofile_view.dart';

class DrawerShowCaseParent extends StatelessWidget {
  final Globals globals;

  const DrawerShowCaseParent({Key? key, required this.globals})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ShowCaseWidget(
      builder: Builder(
        builder: (_) => TutorShowCaseNavigationDrawerWidget(
          globals: globals,
        ),
      ),
    );
...
class TutorShowCaseNavigationDrawerWidget extends StatefulWidget {
  Globals globals;

  TutorShowCaseNavigationDrawerWidget({Key? key, required this.globals})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return TutorShowCaseNavigationDrawerState();
  }
}

class TutorShowCaseNavigationDrawerState
    extends State<TutorShowCaseNavigationDrawerWidget> {
  ...
  Widget buildNavHeader(BuildContext context) {
    ...
    return Showcase(
      key: key,
      description: 'Tap on the header to view your profile',
      onTargetClick: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ProfileShowCaseParent(
