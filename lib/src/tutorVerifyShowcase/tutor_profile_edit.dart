...
class ProfileEditShowCaseParent extends StatelessWidget {
  final Globals globals;
  Uint8List image;
  bool imageExists;

  ProfileEditShowCaseParent(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    return ShowCaseWidget(
      builder: Builder(
        builder: (_) => TutorShowCaseProfileEdit(
          globals: globals,
          image: image,
...
// ignore: must_be_immutable
class TutorShowCaseProfileEdit extends StatefulWidget {
  final Globals globals;
  Uint8List image;
  final bool imageExists;

  TutorShowCaseProfileEdit(
      {Key? key,
      required this.globals,
      required this.image,
      required this.imageExists})
  ...
  @override
  _TutorShowCaseProfileEdit createState() => _TutorShowCaseProfileEdit();
}

class _TutorShowCaseProfileEdit extends State<TutorShowCaseProfileEdit> {
  ...
  Widget buildBody() {
    ...
    return Column(
      children: [
        ...
        Showcase(
          key: key,
          description: 'Click here to upload your transcript',
          child: UploadButton(
            ...
            onPressed: () async {
              ...
              try {
                ...
                const snackBar =
                    SnackBar(content: Text('Transcript Uploaded successfully'));
                ScaffoldMessenger.of(context).showSnackBar(snackBar);
              } catch (e) {
                try {
                  await UserServices.uploadTranscript(fileToUpload,
