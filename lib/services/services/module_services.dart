...
class ModuleServices {
  static getModules() async {
    Uri modulesURL = Uri.https('tutorme.azurewebsites.net', '/api/Modules');
    try {
  ...
  static updateModule(Modules module) async {
    ...
    try {
      ...
      final modulesURL =
          Uri.parse('https://tutorme.azurewebsites.net/api/Modules/$code');
  ...
  static Future getModule(String id) async {
    Uri tutorURL =
        Uri.https('tutorme.azurewebsites.net', '/api/Modules/$id');
    try {
